    ...
    <div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1"
      ...
      <div class="offcanvas-body sidebar-content d-flex flex-column pt-4">
        ...
        <ul class="navbar-nav flex-column" id="navbar-sidebar">
          <!-- Menu item -->
          <li class="nav-item"><router-link :to="{ name: 'Reservation' }" class="nav-link"
              :class="{ active: $route.name === 'Reservation' }">Tableau de
              bord</router-link></li>
          ...
          <li class="nav-item"> <router-link class="nav-link" :class="{ active: $route.name === 'Reservation' }"
              :to="{ name: 'Reservation' }">Location</router-link></li>
        </ul>
        <!-- Sidebar menu end -->
          ...
          <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
            ...
            <li class="nav-item ms-3 dropdown">
              ...
              <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                ...
                <li><router-link class="dropdown-item" href="admin-dashboard.html#"><i
                      class="bi bi-bookmark-check fa-fw me-2"></i>My Bookings</router-link></li>
