    ...
    <div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1"
      ...
      <div class="offcanvas-body sidebar-content d-flex flex-column pt-4">
        ...
        <ul class="navbar-nav flex-column" id="navbar-sidebar">
          <!-- Menu item -->
          <li class="nav-item"><router-link :to="{ name: 'dashboard' }" class="nav-link"
              :class="{ active: $route.name === 'dashboard' }">Tableau de
              bord</router-link></li>
          ...
          <!-- Menu item -->
          <li class="nav-item">
            <router-link class="nav-link" :class="{ active: $route.name === 'listeVehicule' }" data-bs-toggle="collapse"
              href="admin-dashboard.html#collapsebooking" role="button" aria-expanded="false"
              aria-controls="collapsebooking">
              Vehicule
            </router-link>
            <!-- Submenu -->
            <ul class="nav collapse flex-column" id="collapsebooking" data-bs-parent="#navbar-sidebar">
              <li class="nav-item"> <router-link class="nav-link" :to="{ name: 'listeVehicule' }">Liste des
                  Vehicule</router-link></li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse"
              :class="$route.name === 'listeLocation' ? 'active' : ($route.name === 'locationDetails' ? 'active' : '')"
              href="admin-dashboard.html#collapseguest" role="button" aria-expanded="false"
              aria-controls="collapseguest">
              Location
            </a>
            <!-- Submenu -->
            <ul class="nav collapse flex-column" id="collapseguest" data-bs-parent="#navbar-sidebar">
              <li class="nav-item"> <router-link class="nav-link" :to="{ name: 'listeLocation' }">Liste des
                  locations</router-link></li>
            </ul>
          </li>

          <!-- Menu item -->
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" :class="{ active: $route.name === 'listeClient' }"
              href="admin-dashboard.html#collapseagent" role="button" aria-expanded="false"
              aria-controls="collapseagent">
              Clients
            </a>
            <!-- Submenu -->
            <ul class="nav collapse flex-column" id="collapseagent" data-bs-parent="#navbar-sidebar">
              <li class="nav-item"> <router-link class="nav-link" :to="{ name: 'listeClient' }">Liste des
                  Clients</router-link></li>
            </ul>
          </li>
          <!-- Title -->

          <li class="nav-item"> <router-link class="nav-link" :class="{ active: $route.name === 'tarif' }"
              :to="{ name: 'tarif' }">Tarif Chaffeur</router-link></li>
        </ul>
        <!-- Sidebar menu end -->

        <!-- Sidebar footer START -->
        <div class="d-flex align-items-center justify-content-between text-primary-hover mt-auto p-3">
          <a class="h6 fw-light mb-0 text-body" @click="logout" data-bs-toggle="tooltip" data-bs-placement="top"
            aria-label="Sign out">
        ...
        <div class="d-flex align-items-center w-100">
          ...
          <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
            ...
            <li class="nav-item ms-3 dropdown">
              <!-- Avatar -->
              <a class="avatar avatar-sm p-0" href="admin-dashboard.html#" id="profileDropdown" role="button"
              ...
              <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                ...
                <li class="px-3 mb-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <a class="h6 mt-2 mt-sm-0" href="admin-dashboard.html#"> {{ email }} {{ prenom }}</a>
...
export default {
  setup() {
    ...
    return { isAuthenticated, logout, imageUrl: logo, nom, prenom, email, role, };
  }
};
